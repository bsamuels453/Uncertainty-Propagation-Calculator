...
namespace Uncertainty_Propagation_Calculator{
    ...
    internal class LatexToImg{
        ...
        const string _texPrefix = @"\setlength{\voffset}{-1.76in}\setlength{\hoffset}{-2.05in}\setlength{\headsep}{14pt}\setlength{\oddsidemargin}{0pt}\documentclass{article}\begin{document}$";
